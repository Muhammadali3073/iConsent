...
import 'package:i_consent/view/auth/forgot_password_screen/reset_password_screen.dart';
...
class VerificationOTPScreen extends StatelessWidget with MyAppValidations {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: GetButton('Verify', onTap: () {
        final errorMessage = otpScreenErrorHandler(otp: otpController);
